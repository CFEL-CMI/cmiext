...
bn = molecule.Molecule(storage="check.hdf")
...
param.rotcon = convert.Hz2J(num.array([5000.0e6, 1000.0e6, 1500.0e6]))
param.quartic = convert.Hz2J(num.array([50, 900, 500, 10, 600]))
param.dipole = convert.D2Cm(num.array([4., 4., 0.]))
# calculation details
param.M = [0]
param.Jmin = 0
param.Jmax_calc = 5
